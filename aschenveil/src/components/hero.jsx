function Hero() {
  return (
    <div className="text-white text-center p-10 mt-10 flex flex-col items-center">
      <div> <img src="/hero.png" alt="" className="h-80 w-80"/></div>
      ...
      <a href="/" className="bg-amber-700 border border-stone-500 rounded-lg hover:bg-amber-900 p-5 mt-5">Découvrir Aschenveil</a>
    </div>
  );
}
